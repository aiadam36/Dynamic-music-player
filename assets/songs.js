let songs = [
  {
    id: 1,
    title: "Sesungguhnya Aku",
    artist: "Alif Satar",
    album: "Red Velvet Soundtrack",
    albumArtUrl: "assets/img/sesungguhnya-aku.png",
    audioSrc: "assets/music/sesungguhnya-aku.mp3",
    videoBgSrc: "assets/bg/sesungguhnya-aku.mp4",
    lyrics: [
      { time: 0.1, text: "Sesungguhnya aku" },
      { time: 4.3, text: "telah jatuh pada dirimu" },
      { time: 7.4, text: "Sesungguhnya aku" },
      { time: 11.4, text: "mencintai hanya dirimu" },
      { time: 14.6, text: "Kerna sesungguhnya" },
